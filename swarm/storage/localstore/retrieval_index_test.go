...
//
// # go test -benchmem -run=none gitlab.neji.vm.tc/marconi/go-ethereum/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: gitlab.neji.vm.tc/marconi/go-ethereum/swarm/storage/localstore
...
//
// go test -benchmem -run=none gitlab.neji.vm.tc/marconi/go-ethereum/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: gitlab.neji.vm.tc/marconi/go-ethereum/swarm/storage/localstore
