...
import (
	...
	"gitlab.neji.vm.tc/marconi/go-ethereum/ethclient"
	"gitlab.neji.vm.tc/marconi/go-ethereum/ethstats"
	"gitlab.neji.vm.tc/marconi/go-ethereum/les"
	...
	"gitlab.neji.vm.tc/marconi/go-ethereum/p2p/discv5"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://gitlab.neji.vm.tc/marconi/go-ethereum/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
